...
st.set_page_config(page_title="Assurance AI", layout="wide")
st.title("🧠 Assurance AI - Your Own Policy Explainer")
...
if uploaded_file:
    with st.spinner("Uploading and indexing..."):
        response = requests.post(
            ...
            files=[("uploaded_files", (uploaded_file.name, uploaded_file.getvalue()))]  # ✅ Send as list of tuples
        )
